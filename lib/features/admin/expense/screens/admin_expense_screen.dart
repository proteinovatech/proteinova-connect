        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(child: dropdownBox("Branch 034")),

                  const SizedBox(width: 16),

                  Expanded(child: dropdownBox("May, 2025")),
              ...
              Row(
                children: [
                  ...
                  ExpenseSummaryCard(
                    ...
                    onTap: () {
                      showExpenseDetailsBottomSheet("Transport & Fuel");
                    },
                  ),
                ],
              ),
          ...
          Expanded(
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                isExpanded: true,
                items: ["Transport", "Rent", "Salary", "Packing"]
