    ...
    return Scaffold(
      ...
      body: BlocBuilder<SalesDashboardBloc, SalesDashboardState>(
        builder: (context, state) {
          if (state is BranchDashboardLoading) {
            return const Center(
              child: Column(
          ...
          if (state is BranchDashboardError) {
            return Center(
              child: Padding(
          ...
          if (state is BranchDashboardLoaded) {
            ...
            return RefreshIndicator(
              ...
              onRefresh: () async {
                context.read<SalesDashboardBloc>().add(
                  RefreshBranchDashboard(branchId: selectedBranchId),
                );
              },
              child: SafeArea(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Stat Cards Grid 2 (Sales Today, Expense, Eggs Sold, Closing)
                      GridView.count(
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        crossAxisCount: width >= 1000
                        ...
                        children: [
                          ...
                          _buildStatCard(
                            ...
                            value: formatNumber(dashboard.cards.todayTraySold),
                            valueUnit: dashboard.cards.todayTraySold == 1
                                ? "Egg"
                                : "Eggs",
                            ...
                            onTap: () {
                              final data = <Map<String, String>>[
                                <String, String>{
                                  "label": "Total Trays Sold",
                                  "value":
                                      "${dashboard.cards.todayTraySold}",
                      ...
                      // Active Offers & Low Stock Alerts
                      Column(
                        children: [
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<int>(
          ...
          onChanged: (int? newValue) {
            if (newValue != null) {
              context.read<SalesDashboardBloc>().add(SelectBranch(newValue));
            }
          },
    ...
    final addButton = ElevatedButton.icon(
      onPressed: () {
        Navigator.push(
          ...
          if (value == true) {
            context.read<SalesDashboardBloc>().add(
              FetchBranchDashboard(branchId: selectedBranchId),
            );
          }
        });
      },
